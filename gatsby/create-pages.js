...
const createPages = async ({ graphql, actions }) => {
  ...
  createPage({
    path: "/shop",
    component: path.resolve("./src/templates/shop-template.tsx"),
  })
  ...
  _.each(edges, edge => {
    ...
    } else if (_.get(edge, "node.frontmatter.template") === "merch") {
      createPage({
        path: edge.node.fields.slug,
        component: path.resolve("./src/templates/merch-template.tsx"),
        context: { slug: edge.node.fields.slug },
      })
    }
  })
